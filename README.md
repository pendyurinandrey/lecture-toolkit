...
* Создать аккаунт на Hugging Face и выпустить token (см. [Как получить Hugging Face токен?](#как-получить-hugging-face-токен))
* В терминале, где был выполнен шаг 2:
  * Выполнить команду `hf auth login`
  * Ввести токен, полученный на предыдущем шаге
  * Завершить процесс авторизации, следуя подсказкам
...
### Как получить Hugging Face токен?
