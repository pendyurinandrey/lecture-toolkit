"""
Удаление слов-паразитов из потока слов — общий модуль для speech_to_text_whisper
и speech_to_text_gigaam.

Слова на входе могут быть как ещё без пунктуации (speech_to_text_whisper —
паразиты убираются до восстановления пунктуации), так и уже с пунктуацией
("вот,", "«ну", "ж." — speech_to_text_gigaam, где ASR сама расставляет знаки).
